...
<header id="header123" class="logo-left-right headerPM menuPosition transparent" role="banner">
    <div class="wf-wrap">
        <div class="wf-table">
...
<div class="home">
    <div class="content">
        ...
        <div class='ribbon' float="right">
            <a href='/demo4/tmp.jsp'>
                <span>返回主页面</span>
            </a>
        </div>
    </div>
    <div class="container" style="z-index: 0; margin: 50px auto">
        ...
        <table border="1" class="table table-bordered table-hover">
            ...
            <c:forEach var="G" items="${collection}"  >
                <tr>
                    <td>${G.goodid}</td>
                    <td><a href="/demo4/BuyServlet?id=${G.goodid}">${G.goodname}</a></td>
                    <td>${G.goodprice}</td>
                    <td>${G.description}</td>
                </tr>
            </c:forEach>
